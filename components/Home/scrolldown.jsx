    ...
    return (
        <div className="home__scroll">
            <a href="#about" className="home__scroll-button button--flex">
                <svg className="home__scroll-mouse" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 247 390" width="32px" height="32px" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" 
                    style={{
                    fillRule: "evenodd",
                    clipRule: "evenodd",
                    strokeLinecap: "round",
